...
| Wavefront and Zernike | `Phase`, `Phase2`, `WavefrontFit`, `WavePlot` | First-class at Phase 5 export scope | Wavefront maps, Zemax-style Wavefront Function OPD fan, Zernike plots, fit report copy, and CSV exports are available. Add plot-linked coefficient selection only if needed later. |
