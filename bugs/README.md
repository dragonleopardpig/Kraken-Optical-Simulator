...
| [0012](0012-promoted-analytic-row-cant-slide.md) | "after changing to analytical lens, can't slide" — promoted optical-solid row fired a ~0.5 s optical retrace on every drag step ("computes hard, doesn't move") | Fixed (live cheap actor move during the drag; defer the single heavy retrace to release) | `validate_open3d_promoted_row_slide` + Phase 18 |
