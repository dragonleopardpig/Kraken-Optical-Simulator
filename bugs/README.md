...
| [0010](0010-ghost-yellow-face-highlights.md) | "ghost surfaces" — hover *edge* highlights stranded at the lens's old spot after Place→Center Row→Optical axis snaps the (aspheric) lens; re-light on hovering the now-empty region | Open (documented) | — |
| [0011](0011-thickness-overlay-stale-after-move.md) | "Thickness overlay not auto-updated" — after a gizmo move the persistent `gap =` arrows keep the lens's old position; live readout is correct | Open (documented) | — |
| [0012](0012-promoted-analytic-row-cant-slide.md) | "after changing to analytical lens, can't slide" — promoted-row Move arrows render but the axial drag is a no-op | Open (documented) | — |
