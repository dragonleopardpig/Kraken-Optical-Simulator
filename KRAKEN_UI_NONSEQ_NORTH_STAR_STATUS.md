...
| 3D scene with 2D projections | Improving | `█████████░ 98%` | Folded optics marker placement is now planned by pure projected-geometry helpers instead of inline editor drawing math. |
