...
def main() -> int:
    ...
    checks = [
        ...
        ("target orient service writes Tilt and ScenePlacement metadata", "tilt_x" in editor_orient_target and "target_normal" in editor_orient_target and "SCENE_PLACEMENT_ADVANCED_ATTR" in editor_orient_target),
