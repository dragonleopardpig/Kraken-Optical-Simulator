"""Validate the PYRITE 120 mm machine-vision blackbox surrogate."""
...
LAYOUT_PATH = PROJECT_ROOT / "KrakenOS" / "common_optical_layouts" / "machine_vision_120mm_pyrite_datasheet_1x.py"
REFERENCE_LAYOUT_PATH = PROJECT_ROOT / "KrakenOS" / "common_optical_layouts" / "machine_vision_150mm_measured.py"
DOC_PATH = PROJECT_ROOT / "docs" / "source" / "tutorials" / "machine_vision_pyrite_120_surrogate.rst"
...
STATIC_IMAGE = (
    ...
    / "01_pyrite_120_surrogate_layout.png"
)
...
def main() -> int:
    module = importlib.import_module("KrakenOS.common_optical_layouts.machine_vision_120mm_pyrite_datasheet_1x")
    ...
    if failed:
        print("PYRITE 120 mm surrogate validation failed:")
        for name in failed:
            print(f"- {name}")
        ...
        return 1
    print(
        "PYRITE 120 mm surrogate validation passed: "
