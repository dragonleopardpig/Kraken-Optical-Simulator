...
def run_checks(verbose: bool = False, app=None, inspector=None) -> "tuple[bool, list[str]]":
    ...
    # A: the split-field scene follows a resize
    ...
    ok(
        ...
        and near["center"] == [0.0, 0.0, 0.0],
        f"A1: far band -> z=-15, near band anchored ({far['center']}, {near['center']})",
    )
    ok(
        ...
        f"A2: faceB launch follows (z {spec['source_z']}, mirror {spec['mirror_launch_plane_z']}, "
