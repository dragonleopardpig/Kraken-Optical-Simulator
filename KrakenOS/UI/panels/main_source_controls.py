...
class MainSourceControlsPanel:
    ...
    def _commit_source_controls(self, _event=None) -> None:
        # the model owns what a commit does (bugs/0901); this is the Tk callback shape
        self.commit_source_controls(_event)
    ...
    def build(self, parent: tk.Widget) -> None:
        ...
        self.source_model_menu = grid_labeled_commit_combobox(
            ...
            0,
            0,
            control_for("source_model_var").label,
        ...
        self.pupil_pattern_menu = grid_labeled_commit_combobox(
            ...
            0,
            1,
            control_for("pupil_pattern_var").label,
        ...
        source_radius_entry = grid_labeled_commit_entry(
            ...
            2,
            0,
            control_for("source_radius_var").label,
        ...
        source_cone_angle_entry = grid_labeled_commit_entry(
            ...
            2,
            1,
            control_for("source_cone_angle_var").label,
        ...
        gaussian_input_mode_menu = grid_labeled_commit_combobox(
            ...
            4,
            0,
            control_for("gaussian_input_mode_var").label,
        ...
        gaussian_waist_entry = grid_labeled_commit_entry(
            ...
            6,
            0,
            control_for("gaussian_waist_radius_var").label,
        ...
        gaussian_offset_entry = grid_labeled_commit_entry(
            ...
            6,
            1,
            control_for("gaussian_waist_offset_var").label,
        ...
        gaussian_diameter_entry = grid_labeled_commit_entry(
            ...
            8,
            0,
            control_for("gaussian_beam_diameter_var").label,
        ...
        gaussian_divergence_entry = grid_labeled_commit_entry(
            ...
            8,
            1,
            control_for("gaussian_full_divergence_var").label,
        ...
        gaussian_m2_entry = grid_labeled_commit_entry(
            ...
            10,
            0,
            control_for("gaussian_m2_var").label,
        ...
        gaussian_waist_side_menu = grid_labeled_commit_combobox(
            ...
            10,
            1,
            control_for("gaussian_waist_side_var").label,
        ...
        pupil_rad_entry = grid_labeled_commit_entry(
            ...
            12,
            0,
            control_for("pupil_rad_var").label,
            self.pupil_rad_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        pupil_theta_entry = grid_labeled_commit_entry(
            ...
            12,
            1,
            control_for("pupil_theta_var").label,
        ...
        source_power_entry = grid_labeled_commit_entry(
            ...
            14,
            0,
            control_for("source_power_var").label,
        ...
        source_seed_entry = grid_labeled_commit_entry(
            ...
            14,
            1,
            control_for("source_seed_var").label,
        ...
        source_x_entry = grid_labeled_commit_entry(
            ...
            16,
            0,
            control_for("source_x_var").label,
            self.source_x_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_y_entry = grid_labeled_commit_entry(
            ...
            16,
            1,
            control_for("source_y_var").label,
            self.source_y_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_z_entry = grid_labeled_commit_entry(
            ...
            18,
            0,
            control_for("source_z_var").label,
            self.source_z_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_l_entry = grid_labeled_commit_entry(
            ...
            18,
            1,
            control_for("source_l_var").label,
            self.source_l_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_m_entry = grid_labeled_commit_entry(
            ...
            20,
            0,
            control_for("source_m_var").label,
            self.source_m_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_n_entry = grid_labeled_commit_entry(
            ...
            20,
            1,
            control_for("source_n_var").label,
            self.source_n_var,
            on_commit=self._commit_source_controls,
            on_focus_in=self._begin_history_capture,
            width=12,
        ...
        source_direction_preset_menu = grid_labeled_commit_combobox(
            ...
            22,
            0,
            control_for("source_direction_preset_var").label,
        ...
        source_angular_weight_menu = grid_labeled_commit_combobox(
            ...
            24,
            0,
            control_for("source_angular_weight_var").label,
