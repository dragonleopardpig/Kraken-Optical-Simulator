...
class MainOptimizationPanel:
    ...
    def edit_current_bounds(self) -> None:
        ...
        # below upper) and what Save writes live in KrakenOS/UI/row_forms/presets.py. A bad
        # entry goes to the DEBUG LOG and leaves the dialog open, as it always did -- this
        # dialog has never shown a message box.
        ...
        if index is None or spec is None:
            return
        try:
            form = build_optimization_bounds_form(self, index, spec=spec)
