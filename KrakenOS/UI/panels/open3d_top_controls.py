...
class Open3DTopControlsPanel:
    ...
    def build_scene_toolbar(self, parent: tk.Widget) -> ttk.Frame:
        ...
        cad_target_menu.add_command(label="Snap STEP Surface-Center Normal->Optical Axis", command=self.inspector.snap_selected_step_normal_to_optical_axis)
        cad_target_menu.add_command(label="Snap STEP Pick-Point Normal->Optical Axis", command=self.inspector.snap_selected_step_pick_point_normal_to_optical_axis)
