...
def main() -> None:
    args = parse_args()
    mode_aliases = {"illum": "relative_illumination"}
    resolved_mode = mode_aliases.get(args.mode, args.mode)
    if args.file is not None:
        _render_layout_file(args.file, args.output, args.dpi, resolved_mode)
        print(args.output)
        return
