...
TITLE = "Wavefront Interferogram Example"

_REFERENCE_PATH = Path(__file__).with_name("advanced_surface_zernike_example.py")
_SPEC = importlib.util.spec_from_file_location("_kraken_wavefront_interferogram", _REFERENCE_PATH)
