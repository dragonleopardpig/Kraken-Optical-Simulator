TITLE = "Diffuse Object Cosine Lobe Scatter"
...
SURFACES = [
    ...
    },
    {
        ...
        "name": "Glossy cosine-lobe object",
        "rc": 0.0,
        "thickness": 40.0,
        "diameter": 24.0,
        "glass": "MIRROR",
        "axis_move": 2.0,
        "advanced": {
            "DiffuseScatter": COSINE_LOBE_SCATTER,
            "Display2D": {"label": "Cosine lobe object"},
            "Note": (
                "Built-in glossy scatter target. The child rays are deterministic "
                "cosine-power samples around the physical specular reflection direction."
            ),
        },
    },
    {
