...
TITLE = "Wavefront Zernike Fit Example"

_REFERENCE_PATH = Path(__file__).with_name("advanced_surface_zernike_example.py")
_SPEC = importlib.util.spec_from_file_location("_kraken_advanced_zernike", _REFERENCE_PATH)
...
SETTINGS.update(
    {
        "analysis_mode": "zernike",
        "analysis_modes": ["zernike"],
        "ray_count": "15",
    }
)
