...
- Phase 7E adds worst-sample comparison, stack-up dashboard, worst-sample
  ...
  covariance-aware stack-up bars, and nominal-vs-worst spot, MTF, and
...
1. Add richer manufacturing metadata for named tolerance sources and
   compensator eligibility presets.
