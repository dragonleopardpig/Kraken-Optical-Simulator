...
| P | Phase 8 field propagation and hardening | Started with branch-field contract, scalar propagation validator, and UI `BField` analysis | High | High |
