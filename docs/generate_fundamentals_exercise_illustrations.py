...
# This entry uses a larger, hand-authored level-population diagram.  Keep its
# SVG and explanatory caption intact when the generic set is regenerated.
CUSTOM_EXERCISE_SVGS = {"exercise_15_04_01.svg"}
...
META["double_convex"] = DiagramMeta(
    "R₁>0, R₂<0, and central thickness d₀",
    "subtract the two paraxial surface sags",
    "quadratic phase and focal length",
...
META["prism"] = DiagramMeta(
    ...
    "x: height from apex • d(x)=αx: local thickness • d₀: maximum thickness • α: apex angle • n: index • k₀,kₓ: wavevectors • θ: deflection",
    "kₓ=(n−1)k₀α and the small-angle ray limit",
)
...
def icon_markup(category: str) -> str:
    icons = {
        ...
        "prism": '<path class="layer1" d="M535 350 L535 185 L665 185 Z"/><path class="accent" d="M480 270 L598 270 L660 245 L738 220"/><line class="axis" x1="475" y1="270" x2="740" y2="270" stroke-dasharray="8 7"/><line class="axis" x1="535" y1="360" x2="535" y2="170" stroke-dasharray="8 7"/><path class="accent2" d="M535 318 A32 32 0 0 1 555 325"/>',
...
def variable_markup(category: str) -> str:
    ...
    labels = {
        ...
        "prism": '<line class="callout" x1="535" y1="180" x2="665" y2="180"/><path class="tick" d="M535 174 V186 M665 174 V186"/><text class="var" x="600" y="170">d₀</text><line class="callout" x1="535" y1="245" x2="618" y2="245"/><path class="tick" d="M535 239 V251 M618 239 V251"/><text class="var smallvar" x="576" y="235">d(x)</text><text class="var" x="551" y="340">α</text><text class="var" x="520" y="180">x</text><text class="var" x="570" y="300">n</text><text class="var" x="495" y="255">k₀</text><text class="var" x="690" y="215">kₓ</text><text class="var" x="690" y="260">θ</text>',
...
def figure_block(
    ...
    if (chapter, section, item) == (2, "4", "1"):
        caption = f'''**Figure {figure_number} — Exercise 2.4-1: Thin prism.**  The thickness
   ...
   thickness, wavevectors, and resulting positive deflection.'''
    elif (chapter, section, item) == (2, "4", "2"):
...
def transform_exercise_body(
    ...
    if filename not in body:
        ...
        body, replacements = existing_figure.subn(
            lambda _match: replacement, body, count=1
        )
        if replacements != 1:
            raise RuntimeError(
