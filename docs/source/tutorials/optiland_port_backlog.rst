...
.. list-table::
   ...
   * - 1
     ...
     - Cooke triplet from bad starting point to optimized spot/MTF
...
The next port should be a Cooke-triplet optimization case study inspired by
Optiland ``Tutorial_5c_Optimization_Case_Study.ipynb``. It should start from a
deliberately poor Cooke triplet, run spot/MTF analysis, optimize two or three
surface radii/thicknesses, and end with generated before/after screenshots and
a validator that checks the merit improvement.
