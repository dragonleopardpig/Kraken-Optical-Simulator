...
| Open 3D STEP/status readability | Achieved | `██████████ 100%` | Imported STEP body actors now disable mesh scalar coloring so lens/camera/optical/LED overlays use the UI's neutral actor colors. Camera and imaging-lens STEP overlays stay transparent when rays are visible, and the ray-terminal report moves from the canvas text overlay to the bottom status line. |
...
Latest movement on 2026-05-25: Open 3D `Trace now` now preserves the currently
...
Latest movement on 2026-05-25: validation now has a quick first-pass entry
