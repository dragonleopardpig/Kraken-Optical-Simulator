...
live in `services/catalog_metadata.py`. Together these remove more than 2,700
source lines of non-Tk CAD/STL,
...
The main editor coordinator is now 44,470 lines before the next extraction
slice.
