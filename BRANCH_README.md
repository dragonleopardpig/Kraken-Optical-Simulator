...
Practical recommendation: continue Phase 8 by starting the oblique astigmatic
q/matrix slice or by adding richer mode targets to `BField` beyond the fitted
TEM00 reference. Full oblique astigmatic surface matrices should follow once
the branch-field UI contract is stable. The detector-bin Gaussian-q
