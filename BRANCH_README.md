...
`services/surface_value_parsing.py`, and advanced-surface validation now lives
in `services/advanced_surface_validation.py`. Together these remove more than
3,100 source lines of non-Tk CAD/STL,
...
The main editor coordinator is now 43,870 lines before the next extraction
slice.
