...
YZ/XZ/XY panes now project the full displayable canonical ray family; only
explicit `world_sections` diagnostics apply the old near-plane section filter.
