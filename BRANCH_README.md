...
1. Split `KrakenOS/UI/layout_editor.py` into a package-style structure inspired
   ...
   another record-flattening block inside the editor. `KrakenOS/UI/widgets/tooltips.py`
