...
- 2D and Open 3D use the same SceneBundle scene envelope and bounded ray-point
  ...
  intent; a nonzero `Pupil / field` source cone intentionally remains a point
  cone when a STEP overlay is promoted into a non-sequential scene.
