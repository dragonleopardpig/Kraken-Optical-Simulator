...
`services/paraxial_tools.py`. Together these remove more than 12,700
...
layout-projection CAD display/solve-tool logic from the editor coordinator
while keeping backward-compatible symbols available from `layout_editor.py` for
existing validators and panels. The main editor coordinator is now 33,890 lines before
