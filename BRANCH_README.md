...
`services/error_map_metadata.py`. Together these remove about 2,000 source lines
of non-Tk CAD/STL, ray-envelope, STEP-export, and surface-metrology parsing
...
editor coordinator is now 45,245 lines before the next extraction slice.
