...
- Open 3D imported STEP overlays can be carried on an automatically sized
  ...
  target metadata, and the `Drop` button exits carry mode without reopening a
  menu.
