...
| Open 3D optical-solid placement handle center | Achieved | `██████████ 100%` | Row placement translate/rotate handles for promoted STEP optical solids now anchor to the displayed CAD body bounds when a file-backed solid is selected, instead of the row's nominal pose point. This keeps the gizmo attached to the visible prism body after import/place/promote workflows. Right-click face assignment also falls back to display-ray CAD picking across imported STEP overlays and promoted optical-solid rows when VTK lands on a transparent prop, edge overlay, or handle instead of the body actor. |
...
Latest movement on 2026-05-25: the Open 3D service boundary reached 100% for
