...
- Open 3D imported STEP overlays can be carried on an automatically sized
  ...
  a picked traced 3D ray point, and the `Drop` button exits carry mode without
  reopening a menu.
