...
`services/layout_analysis_display.py`. The main editor coordinator is now about
4,859 lines, while validators continue to access the same inherited public
...
plot hover/viewer helpers, table editing leftovers, scene-bundle override
helpers, and example-display defaults out of `layout_editor.py`. The next large
slice should move 2D plot hover, selection-overlay, high-resolution viewer, and
layout pick helpers into a focused plot interaction mixin, then replace
