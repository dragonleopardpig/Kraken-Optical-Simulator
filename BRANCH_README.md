...
- Promoted/file-backed STEP optical solids retain a transparent body in Open 3D
  ...
  draw a dark silhouette edge plus a body-colored feature edge, so the prism or
  imported optical STEP remains readable without switching back to a mesh-heavy
  display.
