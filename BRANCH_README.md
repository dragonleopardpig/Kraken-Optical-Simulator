...
parsing now lives in `services/zemax_prescription_import.py`. Together these
remove more than 2,900 source lines of non-Tk CAD/STL,
...
The main editor coordinator is now 44,177 lines before the next extraction
slice.
