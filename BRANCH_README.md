...
7. Done: add branch-filtered analysis controls so spot/PSF/MTF can use
   selected arms.
...
9. Later: add full polarization/Jones split modes and coherent ghost/interference
