...
1. Split `KrakenOS/UI/layout_editor.py` into a package-style structure inspired
   ...
   `KrakenOS/UI/panels/main_scene_element_dialogs.py`, and
   `KrakenOS/UI/panels/main_scene_source_manager_dialog.py` now own the main
   ...
   Settings, and Scene Source Manager controls while delegating state and
   callbacks back to the editor.
