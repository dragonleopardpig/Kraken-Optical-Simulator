...
- Open 3D imported STEP overlays can be carried on an automatically sized
  ...
  pointer-follow carry, and the `Drop` button exits carry mode without
  reopening a menu.
