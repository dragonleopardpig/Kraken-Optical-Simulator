...
Together these remove more than one thousand source lines of non-Tk CAD/STL
and ray-envelope logic from the editor coordinator while keeping
backward-compatible symbols available from `layout_editor.py` for existing
validators and panels. The main editor coordinator is now 46,185 lines before
