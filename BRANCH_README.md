...
`services/layout_polyline_display.py`. Together these remove more than 11,500
...
layout-projection CAD display logic from the editor coordinator while keeping
backward-compatible symbols available from `layout_editor.py` for existing
validators and panels. The main editor coordinator is now 35,119 lines before
