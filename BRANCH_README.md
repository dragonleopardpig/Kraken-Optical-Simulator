...
and file/import/export workflows moved into `services/layout_import_export.py`.
The main editor coordinator is now below 20,000 lines, while validators
continue to access the same inherited public method names through
`KrakenLayoutEditor`.
